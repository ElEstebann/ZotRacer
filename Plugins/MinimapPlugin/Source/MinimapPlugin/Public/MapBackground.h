...
protected:
	...
	// If true, navigation mesh will be included in the generated snapshot. This functionality only works in editor. Use the render target data afterwards to prepare a texture.
	UPROPERTY(EditAnywhere, Category = "Minimap Background Generation - Editor Only")
